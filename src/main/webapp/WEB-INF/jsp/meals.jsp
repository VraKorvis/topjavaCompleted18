...
<div class="jumbotron">
    <div class="container">
        ...
        <div>
            <button button class="btn btn-primary" onclick="filter()"><spring:message code="meal.filter"/></button>
            <button button class="btn btn-primary" onclick="clearFilter()"><spring:message code="meal.clearFilter"/></button>
        </div>
